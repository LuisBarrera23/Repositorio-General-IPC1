...
public class Crearprofesor extends JFrame implements ActionListener {
    JButton b1,b2;
    ...
    public Crearprofesor() {
        ...
        l1=new JLabel("Agregar Nuevo Profesor");
        ...
        this.setTitle("Agregar nuevo profesor");                //titulo del login 
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==b1){
            ...
            Proyecto1.CrearProfesor(nuevo, contraseña);
            Proyecto1.guardar();
            this.dispose();
        }
        if(ae.getSource()==b2){
