...
public class Potenciador2 extends Thread {
    JLabel label;
    ...
    public Potenciador2(Partida p) {
        this.p = p;
        label=new JLabel();
        int posy=(int) (Math.random()*685+25);
        label.setBounds(1170,posy,40,40);
        ImageIcon imagen=new ImageIcon("src/imagenes/potenciador 2.png");
